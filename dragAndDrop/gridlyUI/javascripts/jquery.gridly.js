  ...
  Gridly = (function () {
    class Gridly {
      ...
      draggingMoved(event) {
        ...
        for (i = k = 0, ref2 = $elements.length;
          (0 <= ref2 ? k < ref2 : k > ref2); i = 0 <= ref2 ? ++k : --k) {
      ...
      position($element, columns) {
        ...
        height = 2e308;
        column = 0;
        for (i = j = 0, ref = columns.length - size;
          (0 <= ref ? j < ref : j > ref); i = 0 <= ref ? ++j : --j) {
        ...
        for (i = k = ref1 = column, ref2 = column + size;
      ...
      structure($elements = this.$sorted()) {
        ...
        columns = (function () {
          var j, ref, results1;
          results1 = [];
          for (i = j = 0, ref = this.settings.columns;
            (0 <= ref ? j <= ref : j >= ref); i = 0 <= ref ? ++j : --j) {
            results1.push(0);
          }
          return results1;
        }).call(this);
        for (index = j = 0, ref = $elements.length;
          (0 <= ref ? j < ref : j > ref); index = 0 <= ref ? ++j : --j) {
      ...
      layout() {
        ...
        for (index = j = 0, ref1 = $elements.length;
          (0 <= ref1 ? j < ref1 : j > ref1); index = 0 <= ref1 ? ++j : --j) {
          $element = $($elements[index]);
      ...
      optimize(originals) {
        ...
        while (originals.length > 0) {
          ...
          index = 0;
          for (index = j = 0, ref = originals.length;
            (0 <= ref ? j < ref : j > ref); index = 0 <= ref ? ++j : --j) {
